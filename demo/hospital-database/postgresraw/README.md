...
Demonstration of PostgresRAW running inside a Vagrant Virtual machine.
...
You can put CSV file into ./dataset folder.

## For developers

### Sources for PostgresRAW and related projects
...
* ldsm-db: groups that are used to define which applications should be deployed by Marathon
