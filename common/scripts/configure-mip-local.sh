...
echo
echo "You can review the configuration located in directory"
echo "  $(realpath "$ROOT/envs/mip-local/etc/ansible/")"
echo "and customise it further for your environment and needs."
echo
echo "More information about the configuration settings can be found in directory"
